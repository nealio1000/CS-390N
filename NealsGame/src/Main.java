...
public class Main implements Runnable {
    ...
    public void start() {
        running = true;
        thread = new Thread(this, "Bubble Game");
        thread.start();
//        try {
//            String musicFile = "assets/sounds/mario.wav";
...
//        }
    ...
    public void init() {
        ...
        window = glfwCreateWindow(width, height, "Neal's Super Awesome Bubble Game", NULL, NULL);
