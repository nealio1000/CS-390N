...
System.out.println("got " + numFaces + " faces");
    ...
    else if(kind.equals("dodecahedron")){
        double phi = input.nextDouble();
        input.nextLine();
        double r = input.nextDouble();
        double inv = 1/phi;
        double R = r * Math.sqrt(3);
        phi = R * phi; // scaled up for size

        inv = R * inv; //scaled up for size

        input.nextLine();

        // Set up vertices ( all 20 vertecies with x,y,z coordinates scaled by 10)
        verts = new Triple[20];
        verts[0] = new Triple(R, R, R); //0...8  form an embedded cube
        verts[1] = new Triple(-R, R, R);
        verts[2] = new Triple(-R, R, -R);
        verts[3] = new Triple(R, R, -R);
        verts[4] = new Triple(R, -R, R);
        verts[5] = new Triple(-R, -R, R);
        verts[6] = new Triple(-R, -R, -R);
        verts[7] = new Triple(R, -R, -R);
        verts[8] = new Triple(0, inv, phi);
        verts[9] = new Triple(0, inv, -phi);  // 8..19 require the golden ration and its inverse for coords
        verts[10] = new Triple(0, -inv, -phi);
        verts[11] = new Triple(0, -inv, phi);
        verts[12] = new Triple(inv, phi, 0);
        verts[13] = new Triple(-inv, phi, 0);
        verts[14] = new Triple(-inv, -phi, 0);
        verts[15] = new Triple(inv, -phi, 0);
        verts[16] = new Triple(phi, 0, inv);
        verts[17] = new Triple(-phi, 0, inv);
        verts[18] = new Triple(-phi, 0, -inv);
        verts[19] = new Triple(phi, 0, -inv);

        //Set up adjacencies  ([vertex number] [the 3 adjacent vertex] )
        adj = new int[verts.length][3];
        adj[0][0] = 8; adj[0][1] = 12; adj[0][2] = 16;
        adj[1][0] = 8; adj[1][1] = 13; adj[1][2] = 17;
        adj[2][0] = 9; adj[2][1] = 13; adj[2][2] = 18;
        adj[3][0] = 9; adj[3][1] = 12; adj[3][2] = 19;
        adj[4][0] = 11; adj[4][1] = 15; adj[4][2] = 16;
        adj[5][0] = 11; adj[5][1] = 14; adj[5][2] = 17;
        adj[6][0] = 10; adj[6][1] = 14; adj[6][2] = 18;
        adj[7][0] = 10; adj[7][1] = 15; adj[7][2] = 19;
        adj[8][0] = 0; adj[8][1] = 1; adj[8][2] = 11;
        adj[9][0] = 2; adj[9][1] = 3; adj[9][2] = 10;
        adj[10][0] = 6; adj[10][1] = 7; adj[10][2] = 9;
        adj[11][0] = 4; adj[11][1] = 5; adj[11][2] = 8;
        adj[12][0] = 0; adj[12][1] = 3; adj[12][2] = 13;
        adj[13][0] = 1; adj[13][1] = 2; adj[13][2] = 12;
        adj[14][0] = 5; adj[14][1] = 6; adj[14][2] = 15;
        adj[15][0] = 4; adj[15][1] = 7; adj[15][2] = 14;
        adj[16][0] = 0; adj[16][1] = 4; adj[16][2] = 19;
        adj[17][0] = 1; adj[17][1] = 5; adj[17][2] = 18;
        adj[18][0] = 2; adj[18][1] = 6; adj[18][2] = 17;
        adj[19][0] = 3; adj[19][1] = 7; adj[19][2] = 16;

        //Set up faces information ( [face number] [vertex number on that face] )
        faces = new int[12][5];
        faces[0][0]=3; faces[0][1]=9; faces[0][2]=10; faces[0][3]=7; faces[0][4]=19;
        faces[1][0]=0; faces[1][1]=12; faces[1][2]=3; faces[1][3]=19; faces[1][4]=16;
        faces[2][0]=12; faces[2][1]=13; faces[2][2]=2; faces[2][3]=9; faces[2][4]=3;
        faces[3][0]=9; faces[3][1]=2; faces[3][2]=18; faces[3][3]=6; faces[3][4]=10;
        faces[4][0]=7; faces[4][1]=10; faces[4][2]=6; faces[4][3]=14; faces[4][4]=15;
        faces[5][0]=16; faces[5][1]=19; faces[5][2]=7; faces[5][3]=15; faces[5][4]=4;
        faces[6][0]=0; faces[6][1]=8; faces[6][2]=11; faces[6][3]=4; faces[6][4]=16;
        faces[7][0]=0; faces[7][1]=8; faces[7][2]=1; faces[7][3]=13; faces[7][4]=12;
        faces[8][0]=1; faces[8][1]=8; faces[8][2]=11; faces[8][3]=5; faces[8][4]=17;
        faces[9][0]=1; faces[9][1]=13; faces[9][2]=2; faces[9][3]=18; faces[9][4]=17;
        faces[10][0]=11; faces[10][1]=5; faces[10][2]=14; faces[10][3]=15; faces[10][4]=4;
        faces[11][0]=5; faces[11][1]=17; faces[11][2]=18; faces[11][3]=6; faces[11][4]=14;

        System.out.println("Finished reading a dodecahedron");
